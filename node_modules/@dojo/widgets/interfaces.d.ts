...
export interface NodeAttributeFunction {
	 ...
	 */
	<T>(this: T, attributes: VNodeProperties): VNodeProperties;
}
...
export interface PropertyComparison<P extends WidgetProperties> {
	 ...
	 */
	diffProperties<S>(this: S, previousProperties: Partial<P>, newProperties: Partial<P>): PropertiesChangeRecord<Partial<P>>;
}
...
export interface WidgetMixin<P extends WidgetProperties> extends PropertyComparison<P> {
	 ...
	 */
	setProperties(this: Widget<WidgetProperties>, properties: Partial<P>): void;
	 ...
	 */
	nodeAttributes: (() => VNodeProperties)[];
